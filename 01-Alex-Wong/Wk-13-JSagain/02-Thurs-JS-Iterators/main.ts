...
console.log(
    "countIntegers([4, 2.2, 5, 6, 4.2, 8.2, 4]) => expect 4",
...
function lengths(str_array: string[]){
...
console.log(
    "lengths(['my', 'cake', 'pudding']) => expect [2,4,7]",
...
function getSquares(num_array: number[]){
...
console.log(
    "getSquares([1, 2, 3, 4, 5]) => expect [1, 4, 9, 16, 25]",
...
console.log(
    "1. total value of machines => expect 5727",
    totalValueOfMachines
)
console.log()
...
console.log(
    "2. Machines over 500 => expect machine:5000, machine:650",
    machinesOver500
)
console.log()
...
console.log(
    "typed totals => expect [{machine:5727},{duck:10},{furniture:1200}]",
    totalByType
)
console.log()
